...
```
我的修改：
python pruning_imagenet.py -a resnet18 --save_dir ./snapshots/resnet152-rate-0.7 --rate_norm 1 --rate_dist 0.4 --layer_begin 0 --layer_end 462 --layer_inter 3  DIR D:\python_script\datasets\tiny-imagenet-200
